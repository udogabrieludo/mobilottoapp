        ...
        <NavbarContainer>
          ...
          <NavMenu>
            <NavItems>
              ...
              >
                Games <Icon.ChevronDown size={16} />
              </NavLinks>
              <NavLinks
                to="/"
                // onClick={dropDown}
      ...
      <div className="container d-flex justify-content-center">
        <div className="col-md-10 ">
          <div
            ...
            onMouseEnter={onMouseEnter}
            onMouseLeave={onMouseLeave}
            className={`menu row ${isActive ? "active" : "inactive"} `}
          >
                      ...
                      >
                        <div className="row">
                          {lists &&
                            lists.map((list, i) => (
                              <div
                                className="col-md-4  col-6 img-wrappers"
                                key={i}
                              >
                                ...
                                <h6>{list.name}</h6>
                                <button className="btn btn-danger check-result">
                                  CHECK RESULT
                                </button>
                              </div>
                            ))}
